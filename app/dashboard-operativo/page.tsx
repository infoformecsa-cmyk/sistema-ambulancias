...
export default function Dashboard() {
  ...
  const reportesHoy = archivos.filter((a) => {
    const fechaReporte = new Date(a.fecha)
    return fechaReporte.toDateString() === new Date().toDateString()
  }).length
          ...
          {GUARDIAS.map((g) => {
            ...
            return (
              <div key={g} className="bg-gray-900 p-5 rounded-xl">
                ...
                {ambulanciasPorGuardia.map(
                  ([ambulancia, personas]: any) => (
                    <div
                      key={ambulancia}
...
```// filepath: /Users/jaimerodriguez/sistema-ambulancias/app/dashboard-operativo/page.tsx
'use client'
