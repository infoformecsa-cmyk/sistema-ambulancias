...
const btn={background:"#1f2937",color:"white",padding:"6px 10px",borderRadius:6,border:"none"}
const btnSmall={...btn,fontSize:12,padding:"4px 8px"}
...
const modalBox={background:"#111827",padding:20,borderRadius:10,width:300}"use client"
