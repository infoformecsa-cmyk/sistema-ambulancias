...
const container: CSSProperties = {padding:30,fontFamily:"Arial",maxWidth:1000,margin:"auto"}
const filtros: CSSProperties = {display:"flex",gap:10,margin:"20px 0"}

const alertRed: CSSProperties = {background:"#fee2e2",padding:15,borderRadius:10,marginBottom:20}
const alertYellow: CSSProperties = {background:"#fef9c3",padding:15,borderRadius:10,marginBottom:20}
...
const textarea: CSSProperties = {width:"100%",height:120}
